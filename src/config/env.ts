...
export const env = {
  ...
  EVENTHUB_ADMIN_API_BASE_URL:
    process.env.EVENTHUB_ADMIN_API_BASE_URL ?? "https://admin.api.eventhub.am",
  EVENTHUB_ADMIN_USERNAME: process.env.EVENTHUB_ADMIN_USERNAME ?? "",
  EVENTHUB_ADMIN_PASSWORD: process.env.EVENTHUB_ADMIN_PASSWORD ?? "",
